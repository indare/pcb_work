...
>
> | 振幅 | switch | OPA1612 THD+N | 判定 |
> |---:|---|---:|---|
> | 4.0 Vrms | TMUX7612 H2 −166.6 | −139.4 | **switch 27.2dB 下。問題なし** |
> | 9.2 Vrms | TMUX7612 H3 −119.7 | −145.3 | **switch 25.6dB 上。支配的** |
>
> **DS 規定点(−136dB)で比べると 9.2V の問題を過小評価する。** THD+N は比なので
> 振幅が上がるほど良くなり、9.2Vrms の `OPA1612` は −145.3dB。
> **振幅を揃えると、スイッチの相対的な悪さは 16dB → 26dB へ拡大する。**
> ⚠ クリップ点をまたいで内挿しないこと（`G=+1` は 8.94〜9.59Vrms でクリップ。
> ただしそれは非反転バッファの同相制限で、`G=+2` の実回路には付かない）。
>
