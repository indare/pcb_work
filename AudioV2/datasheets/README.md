...
| 部品 | 用途 | ローカル | 取得元 |
|---|---|---|---|
| **PT2314E SOP-28** | Bass / Treble（I²C、Amp 前） | [Princeton_PT2314.pdf](Princeton_PT2314.pdf) | Princeton Technology PT2314 v1.1。**採用は `PT2314E`**（ピン配置は無印と同一。E の DS は未収録） |
...
- 2026-09-06: `LT1763`。`U1604` の置き換え候補を「6 V の壁」で足切りする根拠がここ
