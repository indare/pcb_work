...
| **MCP23017** | **MCP23017-E/SP**（DIP-28） | 回路どおり。Board A=0x20 / B=0x21 |
| **ULN2803** | **ULN2803AN**（DIP-18） | コイル 40 mA × 複数。COM は +5 V |
...
| 図上 Value の MPN | 現状は役割名のみ（`A50k Dual` / `DEST L`）。**7303 / RK27112 等の記載はレイアウト時** |
