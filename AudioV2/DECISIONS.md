...
### 11.1a 切替素子を**ラッチングリレーへ戻す**（2026-09-02 確定）

**決定: 切替素子は ラッチング DPDT リレー ×20**（1ch につき入力L/R 用と出力L/R 用の各1個）。
**1枚基板への統合（`AmpBank`）はそのまま維持する。** 撤回するのは切替素子の選択だけ。
