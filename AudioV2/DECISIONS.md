...
| パネル 12 V LED | アナログ ±12 V **とは別**。CH224 **12 V ジャンパ** or PD 後段から **+12 V 単極**（要配線設計） |
...
```text
[50224 CH224 PD（12V or 15V ジャンパ）] ──► DKMW20F-12 ──► ±12V / A_GND
         │（12V タップ）                         ├──► Amp / HP Buffer（Audio/ 流用）/ PGA2310 / 計測
         └──► パネル 12V LED（±12V とは別）       └──► 操作 Pico 用 +5V 等（BP5293 等）
