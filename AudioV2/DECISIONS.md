...
## 6. KiCad 起こし範囲 — **ユーザー選択待ち**

サブエージェント 2 件の調査を反映（2026-08-30）。**ここだけはあなたの選択で確定**する。
...
### 6.6 あなたへの質問（返信で選んでください）

**Q1. 起こし範囲:** **A / B / C / D** のどれにしますか？

**Q2.（A または D→A の場合）CH224:** **a 基板移設** / **b ワイヤ** / **どちらでも**

**Q3.（任意）Amp を親シートに:** **a 端子台のみ** / **b Audio 階層リンク**
...
3. ~~ENC 配線~~ → **§10 確定**
4. **起こし範囲（§6）** ← **ユーザー選択待ち**
5. KiCad 起こし（PGA2310 + PT2314 + 出力段ラッチング + 選んだ範囲）
...
- [ ] **起こし範囲（§6 Q1）:** ☐ **A D1.5** ☐ B D1 ☐ C D2 ☐ D D3→A — **未選択**
- [ ] CH224 実装（§6 Q2、A 時）: ☐ 基板移設 ☐ ワイヤ ☐ どちらでも
- [ ] Amp 親シート（§6 Q3）: ☐ 端子台のみ ☐ Audio 階層リンク
