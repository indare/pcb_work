...
| **PB** | ○ | 同上 | PGA2310 直後に DEST。コイルノイズに注意 |
...
### 11.4 OutputStage の物理位置（Q2）

信号順: `… → Amp → PGA2310 → **DEST リレー** → HP / LINE / MUTE`

| | 配置 | 向く理由 |
|---|---|---|
| **Q2-A** | ControlPanel **同一 PCB** | PGA2310 直後。ENC_DEST と同居 |
| **Q2-B** | **HP/LINE 近傍**の独立 PCB | 最終出力が短い。Audio HP Buffer 流用と整合 |
| **Q2-C** | RelayBoard **同居** | ラッチング集約。アナログ幹線は **最長**（非推奨寄り） |
