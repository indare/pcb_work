...
| **精密 DIRECT** | **約 7 Vrms（10 Vpk）** | **`TMUX7612` 可** | 交差点 7.9 Vrms の手前。**23 dB のマージン** |
| フルレンジ DIRECT | 9.2 Vrms（±13 Vpk） | **リレー等**（`TMUX7612` 不可） | 9.2 Vrms で switch が DUT を 25.6 dB 上回る |

**`TMUX7612` を「4〜5 Vrms まで」に縛る必要はない。** 7.07 Vrms でも
switch 最大次数は −167.2 dB で、`OPA1612` より 23.8 dB 下。
