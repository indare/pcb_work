...
出典: `datasheets/TMR9_Datasheet.pdf` / `datasheets/TMR12WI_Datasheet.pdf`
...
5. さらに余裕が要るなら **計測用 TEC 3 + Amp 用 TMR 6** の 2 台分け（負荷変動が ADC に乗らない）。TMR 9/12 への単体載せ替えは Cout が減るので使わない（§1.2）
