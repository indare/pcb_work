...
**次にやること**: 電源ルートを決めたら、生成スクリプトと回路図へ入れる（娘: 電源用・音声用リレー、ch ごとの電源ゲート一式と入力の切り替え、デコーダ、B1/B2、排他ゲート。親: RS6、ADC の電源とグランドの付け替え、`TONE` のプルダウン、L7805C、`PD_12V_SW` の検知、制御専用の MCP23017 と電源検知の AND、トーン NJW1194 と ±7 V の LDO）。
