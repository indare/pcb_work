...
**次にやること（2026-09-26）**: 決定の全体の否定側査読が済んだ（Claude 5 観点・Cursor 7 観点・反証 4 束）。統合リストは [review/whole_review.md](review/whole_review.md)。骨格は崩れなかった。**ユーザーの判断待ち**: U-01〜U-15（図に入る前に要るのは U-01 縦積みの積み方・U-02/U-03 電源断の LDO の逆電圧・U-04 ヒューズ・U-05 ソケット短絡・U-06 ±15 V の枝・U-07 ADC の足場・U-13 部品の確保）。決まったら DECISIONS に入れ、そのあと図と生成スクリプトへ。
