...
| V21-未決-14 | DIRECT の置き方と切替、ライン入力の振幅の定義 | **→ §1-6**（ユーザー判断 2026-09-26: トーンは NJW1194、DIRECT はチップの中で作りリレーは置かない）。**振幅は §1-5**（公称 2 Vrms・上限 2.3 Vrms、両経路で共通）。残る: スルーかトーン 0 dB か | §1-5・§1-6 |
