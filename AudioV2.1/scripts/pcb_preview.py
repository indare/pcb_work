...
`AMP_SEL_*` と `SEL_CH*` は強調する（配線方針: AMP_SEL は B.Cu、SEL とは並走させない）。
    ...
    python3 AudioV2.1/scripts/pcb_preview.py 543 153 571 178 -o out/u311.png --scale 40
    python3 AudioV2.1/scripts/pcb_preview.py --region AmpBankSwitch -o out/sw.png
