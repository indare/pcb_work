...
使い方:
  python3 AudioV2.1/scripts/digikey_search.py "AM10TW-2415DLPZ"
  python3 AudioV2.1/scripts/digikey_search.py "isolated dc dc converter" --limit 25
  python3 AudioV2.1/scripts/digikey_search.py "AM10TW" --csv out/dk.csv
  python3 AudioV2.1/scripts/digikey_search.py --check      # 認証だけ試す
