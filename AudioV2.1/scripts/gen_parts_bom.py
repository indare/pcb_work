...
使い方:
    python3 AudioV2.1/scripts/gen_parts_bom.py           # 生成して PARTS.md を更新
    python3 AudioV2.1/scripts/gen_parts_bom.py --check   # 実図とズレていれば exit 1（更新しない）
    python3 AudioV2.1/scripts/gen_parts_bom.py --print   # 差し込む内容を stdout に出すだけ
...
BLOCKS = [
    {
        ...
        # （docstring の ⚠ 参照）。
        "sheet": "AudioV2.1/AudioV2Case.kicad_sch",
        "fields": _FIELDS,
        "labels": _LABELS,
        "group_by": _GROUP_BY,
    ...
    },
    {
        ...
        "id": "ampchannel-bom",
        "sheet": "AudioV2.1/AmpChannel.kicad_sch",
        "fields": _FIELDS,
        "labels": _LABELS,
        "group_by": _GROUP_BY,
        "dedupe_column": _DEDUPE,
...
TARGET_DOC = "AudioV2.1/PARTS.md"
RUNNER = "docker/kicad-cloud-build/kicad-run.sh"
SELF = "AudioV2.1/scripts/gen_parts_bom.py"
