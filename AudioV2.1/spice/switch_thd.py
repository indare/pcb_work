...
使い方:
  python3 AudioV2.1/spice/switch_thd.py                    # 本番判定（通し）
  python3 AudioV2.1/spice/switch_thd.py --stage input      # 入力側だけ
  python3 AudioV2.1/spice/switch_thd.py --vout 7.07        # 出力振幅を変えて
"""
...
GAIN = 2.0            # AmpBank 1ch のゲイン（20k/20k、v2 の決定ログ §8。値の正は AmpChannel.kicad_sch）
